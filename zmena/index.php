...
if (!loggedIn()) {
	...
	$inputs .= '<input type="text" name="login" id="login" class="form_input" placeholder="Login" value="' . $user->getLogin() . '">
				<input type="text" name="email" id="email" class="form_input" placeholder="Email" value="' . $user->getEmail() . '">
				...
				<input type="password" name="cPass" id="cPass" class="form_input" placeholder="Současné heslo">
...
<body>
	...
	<div class="main">
		<?php echo SIDEPANEL; ?>
		<div class="user">
			<form class="form_full_center" action="php/zmena.php" method="post" style="margin: 0;">
